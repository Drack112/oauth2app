...
Aplicativo com função de testar a autenticação Oauth do google. 🥰
...
#### 3. Preencha o arquivo `.env.example`
...
Esses arquivos podem ser encontrados na plataforma Google Cloud Plataform.

#### 4. Iniciando o app Mobile
